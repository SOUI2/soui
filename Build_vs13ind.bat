...
if %selected%==1 (
	...
	SET vsvarbat="D:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\vcvarsall.bat"
	call !vsvarbat! %target%
	rem call "D:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\vcvarsall.bat" %target%
	goto toolsetxp
) else if %selected%==5 (
